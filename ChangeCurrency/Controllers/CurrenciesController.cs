...
namespace CurrencyChange.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ten,Tygia")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ten,Tygia")] Currency currency)
        {
            if (id != currency.Id)
            {
                return NotFound();
